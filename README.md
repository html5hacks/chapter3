...
<pre>
$ git clone git@github.com:html5hacks/chapter3.git
$ cd chapter3
</pre>

Or [download the latest release](https://github.com/html5hacks/chapter3/archive/master.zip).
...
<pre>
$ git clone git@github.com:[your_github_username]/chapter3.git
$ cd chapter3
</pre>
...
Make sure your current directory is chapter3 before step 3.

<pre>
$ cd [your repos path]/chapter3
</pre>
...
Start the chapter3 demo server from a different terminal window:
